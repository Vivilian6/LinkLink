...
{
    //访问游戏内部数据存储接口
    SharedPreferences preferences;//数据读取
    SharedPreferences.Editor editor;//存储数据
    //反馈输入窗口
    private EditText et;
    //窗口的布局
    private LinearLayout ll;
    //相关的按钮
    private ImageButton btnExit,btnSetting;
    private Button btnBag,btnShop,btnAddDiamond,btnAddGold,btnAuthor,btnFeedback,btnResetUser;
    //金币,砖石,用户名显示
    private TextView tvDiamond,tvGold,tvUsername;
    //反馈窗口
    private AlertDialog feedbackAD;
    //鸣谢窗口
    ...
    private void init()
    {
        ...
        btnSetting = (ImageButton) findViewById(R.id.settingBtn);
        ...
        //获取动画
        amBtn = AnimationUtils.loadAnimation(this, R.anim.scale_big_animation);
       ...
       //给背包设置了一个背景
        ...
        feedbackAD = new AlertDialog.Builder(MainActivity.this)
